...
# Data loading params
train_file = "../dataset/train_in_test.csv"
test_file = "../dataset/test.csv"
output_file = "./test_output6.csv"
...
class Linear(nn.Module):
    def __init__(self):
        ...
        self.tanh = nn.Tanh()
        # 4 > 2 
        self.linear1 = nn.Linear(1+sst_dim+ssn_dim+st_dim, 2)
    ...
    def forward(self, user, song, sst, ssn, st):
        ...
        x = torch.sum(torch.mul(user, song), dim=1, keepdim=True)

        input_ = torch.cat([x,sst,ssn,st], 1)
